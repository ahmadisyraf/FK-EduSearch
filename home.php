                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p>This is the expert's answer to the question. Laravel is considered one of the best PHP frameworks due to its robust features and ease of use. Some advantages of Laravel include...</p>
                                </div>
                            </div>
                            <button class="btn btn-icon btn-transparent btn-report position-absolute top-0 end-0" type="button">
