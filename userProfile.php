    ...
    <div class="container-fluid px-5">
        ...
        <div class="card text-left w-90">
            <div class="card-body">
                <form class="row g-3">
                <div class="col-md-12">
                    <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" class="rounded-circle" style="width: 200px;"
                    alt="Avatar"/>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    ...
                    <select class="form-select" id="inputState" required>
                        <option selected disabled value="">Choose...</option>
                        <option value="Pahang">Software Engenineering</option>
                        <option value="Perak">Graphic and Multimedia</option>
                        <option value="Terengganu">Networking</option>
                    </select>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select" id="inputState" required>
                        <option selected disabled value="">Choose...</option>
                        <option value="Pahang">Active</option>
                        <option value="Perak">Unactive</option>
                    </select>
                </div>
                <div class="col-md-12">
